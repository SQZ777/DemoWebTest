...
public class DemoWebTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		chromeDriver.findElement(By.xpath("//*[@id=\"lst-ib\"]")).sendKeys("1+1");                     //針對搜尋列輸入1+1
		chromeDriver.findElement(By.xpath("//*[@id=\"tsf\"]/div[2]/div[3]/center/input[1]")).submit(); //針對按鈕進行Submit動作
